...
import { BarChart3, Boxes, ClipboardList, DollarSign, FileText, FlaskConical, Home, Layers3, Package, ShieldCheck, TrendingUp, type LucideIcon } from "lucide-react";
...
const NAV_ITEMS: NavItem[] = [
  { label: "Inicio", href: "/kefir-control/", icon: Home, activeMatch: "/kefir-control/" },
  { label: "Inventario de Producción", href: "/kefir-control/inventory", icon: Boxes, activeMatch: "/kefir-control/inventory" },
  { label: "Kárdex de Planta", href: "/kefir-control/kardex", icon: FileText, activeMatch: "/kefir-control/kardex" },
  { label: "Lotes", href: "/kefir-control/lotes", icon: Layers3, activeMatch: "/kefir-control/lotes" },
...
export default function KefirControlLayout({ title, subtitle, children }: KefirControlLayoutProps) {
        ...
        <aside className="hidden border-r border-slate-200 bg-white lg:flex lg:flex-col">
          <div className="flex items-center gap-3 border-b border-slate-100 px-5 py-4">
            ...
            <div className="min-w-0">
              <p className="truncate text-lg font-black tracking-tight">KéfirControl</p>
            ...
            {NAV_ITEMS.map((item) => {
              const isActive = item.activeMatch
                ? item.activeMatch === "/kefir-control/"
                  ? location === "/kefir-control/" || location === "/kefir-control/index.html"
          ...
          <div className="border-t border-slate-100 p-4">
            <div className="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3">
              ...
              <p className="mt-1 text-sm font-semibold text-slate-900">Módulo ordenado por subrutas</p>
            </div>
          </div>
        </aside>
